---
title: PyconAU talk on the tetun.org machine translator
date: '2021-09-11'
tags: ['language-tech', 'speaking']
draft: false
summary: 'Mel Mistica and I presented on how we setup a volunteer-led English-Tetun machine translation service. Since then we passed 25,000 monthly active users.'
authors: ['sparrowhawk']
badge: Speaking
link: https://www.youtube.com/watch?v=lixOk2b4CR4
---
